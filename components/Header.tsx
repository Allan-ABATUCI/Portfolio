...
export default function Header() {
    return (     
        <header className="z-999 relative">
                <motion.div className="fixed top-0 left-1/2 -translate-x-1/2 h-18 w-full rounded-none 
                ...
                <nav className="flex fixed top-[0.15rem] left-1/2 h-12 -translate-x-1/2 py-2 sm:top-[1.7rem] sm:h-[initial] sm:py-0">
                    <ul className="flex w-88 flex-wrap items-center justify-center gap-y-1 text-[0.9rem] font-medium text-gray-500 
